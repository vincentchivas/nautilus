...
def submit_line(context):
    ...
    return {
        ...
        #        'show_save_and_sync': (not is_popup ) or
        #                (context.get('is_sync_button_show', False)),
        'is_popup': is_popup,
        'show_save': True
    }
submit_line = register.inclusion_tag(
    'admin/submit_line.html', takes_context=True)(submit_line)
