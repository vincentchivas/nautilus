...
class Command(NoArgsCommand):
    ...
    def handle_noargs(self, **options):
        ...
        # admin.autodiscovery()
        # allModelAdmin = custom_site._registry
        # for sampleModel in allModelAdmin:
        # print "created_models is ", created_models
        ...
        if load_initial_data:
            ...
            call_command('loaddata', 'initial_data',
                         verbosity=verbosity, database=db)
