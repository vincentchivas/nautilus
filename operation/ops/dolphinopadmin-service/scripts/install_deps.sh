...
SYS_DEPS=(python-pip python2.6-dev libxml2-dev python-excelerator unzip)

PYTHON_DEPS=( "uwsgi" "django==1.4" "pymongo==2.1" "pytz" "MySQL-python" "PIL")  #0.9.6.8, with version ,pip cannot find it
