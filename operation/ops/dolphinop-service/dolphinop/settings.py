...
MIDDLEWARE_CLASSES = (
    ...
    'dolphinop.service.middleware.SetRemoteAddrMiddleware',
    #'dolphinop.service.middleware.SetRemoteCountryMiddleware',
)

#SESSION_ENGINE = 'django.contrib.sessions.backends.file'
#SESSION_SAVE_EVERY_REQUEST = True

ROOT_URLCONF = 'dolphinop.urls'

SITE_ROOT = '/home/mobotk/workspace/dolphin_operation/DolphinOperation/ops/dolphinop-service/dolphinop'
...
TEMPLATE_DIRS = (
    ...
    #    "/var/app/enabled/dolphinop-service/templates/",
    #    "/var/app/enabled/dolphinop-service/web/templates/",
...
LOGGING = {
    ...
    'handlers': {
        ...
        'err': {
            ...
            'class': 'logging.handlers.TimedRotatingFileHandler',
            'formatter': 'detail',
            'filename': '/tmp/dolphinop_service.err',
            'when': 'D',
            'backupCount': 7
        },
    },
...
SECTION = 'dolphinop-service'
DOMAIN = None
SERVER = None


def _load_config():
    global DEBUG, STATIC_URL, MAX_IP_COUNT_PER_DAY, MAX_SIM_COUNT, DATA_DIR, TEMPLATE_DEBUG, DOLPHINOP_DB, REQUEST_TIME_OUT, MAX_RETRY_COUNT, HTTP_MAX_AGE, DEFAULT_LANGUAGE, COMPRESS_ENABLED, DOMAIN, SERVER, DB_CONN, DIFF_IP
    cp = ConfigParser()
    cp.read(["/var/app/enabled/dolphinop-service/dolphinop-service.cfg"])
    ...
    DIFF_IP = cp.get(SECTION, 'diff_ip')
    LOGGING['handlers']['file']['filename'] = os.path.join(
        logs_dir, 'dolphinop.log')
