...
def _get_rawdata(request, args, dbmodule, func_name):
    ...
    if args["sid"]:
        extend_cond['_key.sid'] = {'$in': args["sid"]}
...
def get_data(request):
    ...
    if args['operator'] not in OPERATORS:
        args['operator'] = OTHER
    for q in (
            args['package_name'], args['source'], args['version'], args['cid'],
