# -*- coding: utf-8 -*-
import logging
from provisionadmin.utils.common import md5_string, unix_time
...
class UserLog(ModelBase):
    ...
    @classmethod
    def search_log_info(cls, cond={}, fields={}, toarray=True):
...
class User(ModelBase):
    ...
    def new(cls, user_name, password='', is_active=True, department='',
        ...
        instance.created = instance.last_login = unix_time()
        instance.modified = unix_time()
    ...
    @classmethod
    def get_country_info(cls, group_id):
        dplist = []
        department_list = Department.find_deparments({})
        for department in department_list:
            if group_id in department.get("groups"):
                department.pop("groups")
                dplist.append(department)
        return dplist
    ...
    def get_charge_info(cls, department_name):
        ...
        cond2 = {"department": department_name, "group_id": 4}
            ...
            if user.get("is_superuser"):
                ...
                if gids:
                    for gid in gids:
                        ...
                        group = groups[0]
                        perm_list = perm_list + group.get("permission_list")
